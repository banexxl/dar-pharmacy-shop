               ...
               >
                    ...
                    >
                         ...
                         >
                              ...
                              <h3 style={{ color: Colors.primary.main, fontStyle: 'italic', fontFamily: 'monserrat', marginTop: '50px' }}>
                              ...
                              <BannerQuotaText>
                                   ...
                                   <Link rel='canonical' href={"/kontakt"}>
                                        <Typography component={'span'} sx={{ display: 'inline', fontSize: isMobile ? '1.2rem' : '2rem' }}>
                                             kontakt forme
                                        </Typography>
                                   </Link>
                              </BannerQuotaText>

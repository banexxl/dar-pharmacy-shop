...
import { Button, Paper, Table, TableBody, TableRow, Typography } from '@mui/material'
     ...
     return (
          <CartWrapper theme={theme}>
               ...
               <StyledTotalsTitle theme={theme}>
                    {totalItemPrice < 8000 ? `Ukupno sa PDV i dostavom: ${parseFloat(totalItemPrice).toFixed(2)} RSD` : `Ukupno sa PDV, besplatna dostava: ${parseFloat(totalItemPrice).toFixed(2)} RSD`}
               </StyledTotalsTitle>

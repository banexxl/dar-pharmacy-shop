                              ...
                              <Box sx={{ mt: '70px' }}>
                                   ...
                                   <List sx={{ listStyleType: 'num', pl: 6 }}>
                                        ...
                                        <ListItem sx={{ display: 'list-item', fontStyle: 'italic', color: Colors.primary.lighter, textAlign: 'center', padding: '0px 20px 0px 20px' }}>
                                             <ListItemText>
                                                  <Typography textAlign='justify' >
                                                       da u slučaju nesaobraznosti robe po ugovoru, potrošač ima pravo da izjavi reklamaciju na način kako je to definisano Pravilnikom o postupanju po reklamaciji potrošača za robu kupljenu putem ONLINE prodavnice, koji se može preuzeti <Link rel='canonical' href={'/docs/Zahtev_za_reklamaciju.pdf'}>OVDE.&nbsp;</Link>
                                                       Obrazac Zahteva za reklamaciju potrošač može pronaći u odeljku Servis - <Link rel='canonical' href={'/informacije/zahtev-za-reklamaciju'}>REKLAMACIJE.</Link>
                                                  </Typography>
                                             </ListItemText>
                                        </ListItem>
                                        <ListItem sx={{ display: 'list-item', fontStyle: 'italic', color: Colors.primary.lighter, textAlign: 'center', padding: '0px 20px 0px 20px' }}>
                                   ...
                                   <Typography textAlign='justify' padding='20px 20px' sx={{ textAlignLast: 'left' }}>
                                        Izjavu o odustanku od ugovora možete preuzeti - <Link rel='canonical' href={'/docs/Izjava_o_odustanku.pdf'}>OVDE.</Link>
                                   </Typography>

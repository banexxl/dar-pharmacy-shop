...
export default function DARSavetnikPage() {
          ...
          <List>
            ...
            <ListItem sx={{ display: 'flex', gap: '20px' }}>
              ...
              <Typography textAlign="justify">
                ...
                <Link href="/kontakt" style={{ textDecoration: 'underline' }}>linku.</Link>
              </Typography>
            </ListItem>
            <ListItem sx={{ display: 'flex', gap: '20px' }}>
              <ListItemIcon sx={{ justifyContent: 'right' }}>•</ListItemIcon>
            ...
            <ListItem sx={{ display: 'flex', gap: '20px' }}>
              <ListItemIcon sx={{ justifyContent: 'right' }}>•</ListItemIcon>
              <Typography>Da biste dobili adekvatan savet, molimo vas da navedete:</Typography>
            </ListItem>
            <List sx={{ ml: '20px' }}>
              <ListItem sx={{ display: 'flex', gap: '20px' }}>
                <ListItemIcon sx={{ justifyContent: 'right' }}>•</ListItemIcon>
                <Typography textAlign="justify">da li imate neku hroničnu bolest (hipertenziju, dijabetes, srčanu aritmiju itd.);</Typography>
              </ListItem>
              <ListItem sx={{ display: 'flex', gap: '20px' }}>
                <ListItemIcon sx={{ justifyContent: 'right' }}>•</ListItemIcon>
                <Typography textAlign="justify">da li već uzimate neke lekove (tačan naziv leka koji uzimate);</Typography>
              </ListItem>
              <ListItem sx={{ display: 'flex', gap: '20px' }}>
                <ListItemIcon sx={{ justifyContent: 'right' }}>•</ListItemIcon>
                <Typography textAlign="justify">da li ste alergični na neke lekove (npr. penicilin, acetilsalicilnu kiselinu…);</Typography>
              </ListItem>
              <ListItem sx={{ display: 'flex', gap: '20px' }}>
                <ListItemIcon sx={{ justifyContent: 'right' }}>•</ListItemIcon>
                <Typography textAlign="justify">da li ste trudni ili dojite;</Typography>
              </ListItem>
              <ListItem sx={{ display: 'flex', gap: '20px' }}>
                <ListItemIcon sx={{ justifyContent: 'right' }}>•</ListItemIcon>
                <Typography textAlign="justify">vaše godine i pol;</Typography>
              </ListItem>
              <ListItem sx={{ display: 'flex', gap: '20px' }}>
                <ListItemIcon sx={{ justifyContent: 'right' }}>•</ListItemIcon>
                <Typography textAlign="justify">sve ono što smatrate važnim, a tiče se postavljenog pitanja.</Typography>
              </ListItem>
            </List>
            <ListItem sx={{ display: 'flex', gap: '20px' }}>
              <ListItemIcon sx={{ justifyContent: 'right' }}>•</ListItemIcon>

...
export default function IsporukaIPlacanjePage() {
  return (
      ...
      <Stack>
        <Box>
          ...
          <Typography textAlign="justify" padding="20px 20px">
            ...
            <Typography component="span" sx={{ fontWeight: 'bold' }}>1-5 radnih dana, </Typography>
          ...
          <Typography textAlign="justify" padding="20px 20px">
            ...
            <Typography component="span" sx={{ fontWeight: 'bold' }}>8000 dinara plaća kupac. </Typography>
            Za sve porudžbine preko{' '}
            <Typography component="span" sx={{ fontWeight: 'bold' }}>8000 dinara isporuka je besplatna.</Typography>
          </Typography>
          <Typography textAlign="justify" padding="20px 20px">
            ...
            <Link href="http://www.postexpress.rs/struktura/lat/cenovnik/cenovnik-unutrasnji-saobracaj.asp" target="_blank">
              <Typography component="span" sx={{ fontWeight: 'bold' }}>cenovnik</Typography>
            </Link>.
          </Typography>
          ...
          <Typography textAlign="justify" padding="0px 20px" sx={{ fontSize: '1.2rem', fontWeight: 'bold' }}>
